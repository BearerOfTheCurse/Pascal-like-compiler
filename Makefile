...
CXX_SRCS = main.cpp cpputil.cpp node.cpp ast.cpp context.cpp symbol.cpp symtab.cpp type.cpp cfg.cpp highlevel.cpp x86_64.cpp \
	astvisitor.cpp insgenerator.cpp irprinter.cpp codegenerator.cpp
